...
namespace Jira.SDK
{
    public class JiraClient : IJiraClient
    {
        ...
        private const String JiraAPIServiceURI = "/rest/api/3";
        private const String JiraAgileServiceURI = "/rest/greenhopper/3";
        ...
        private T Execute<T>(JiraObjectEnum objectType, Dictionary<String, String> parameters = null, Dictionary<String, String> keys = null) where T : new()
        {
            ...
            var oo = Client.Execute(GetRequest(objectType, parameters ?? new Dictionary<String, String>(), keys ?? new Dictionary<String, String>()));
